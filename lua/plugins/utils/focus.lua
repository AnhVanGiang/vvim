return {
    ...
    config = function()
        ...
        local ignore_filetypes = { "neo-tree", "Outline", "Avante", "terminal", "nofile" }
        local ignore_buftypes = { "nofile", "prompt", "popup" }

        -- Create an autocommand group
        local augroup = vim.api.nvim_create_augroup("FocusDisable", { clear = true })

        -- Disable focus autoresize for specific buffer types
        ...
        -- Disable focus autoresize for specific file types
